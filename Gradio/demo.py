...
def process_message(message, global_state, REQUIRED_INFO, CURRENT_STAGE, chat_history, download_btn):
    global target_path, args
    ...
    try:
        ...
        if CURRENT_STAGE == 'reupload_dataset':
            ...
            CURRENT_STAGE = 'initial_process'
            yield global_state, REQUIRED_INFO, CURRENT_STAGE, chat_history, download_btn
            return process_message(message, global_state, REQUIRED_INFO, CURRENT_STAGE, chat_history, download_btn)
        ...
        if CURRENT_STAGE == 'report_generation':    
            ...
            yield global_state, REQUIRED_INFO, CURRENT_STAGE, chat_history, download_btn
            try_num = 1
            report_path = call_report_generation(global_state, output_dir)
...
def clear_chat(REQUIRED_INFO, CURRENT_STAGE):
    global target_path, output_dir, chat_history
    ...
    return REQUIRED_INFO, chat_history, CURRENT_STAGE
...
""") as demo:
    ...
    with gr.Row():
        ...
        for name, demo_btn in demo_btns.items():
            ...
            demo_btn.click(
                ...
                fn=process_message,
                inputs=[msg, state, REQUIRED_INFO, stage_state, chatbot, download_btn],
                outputs=[state, REQUIRED_INFO, stage_state, chatbot, download_btn],
                queue=True,
                concurrency_limit=MAX_CONCURRENT_REQUESTS
            ).then(
    ...
    reset_btn.click(
        fn=clear_chat,
        inputs=[REQUIRED_INFO, stage_state],
        outputs=[REQUIRED_INFO,chatbot, stage_state],
