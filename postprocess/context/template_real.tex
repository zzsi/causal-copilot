...
\begin{figure}[H]
    ...
    \begin{{subfigure}}{{0.5\textwidth}}
        \centering
        \includegraphics[width=\linewidth]{[RESIDUAL_GRAPH]}
        \vfill
        \caption{Residual Plot}
    \end{{subfigure}}
    \begin{{subfigure}}{{0.5\textwidth}}
        \centering
        \includegraphics[width=\linewidth]{[QQ_GRAPH]}
        \vfill
        \caption{Q-Q Plot}
    \end{{subfigure}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \vspace{-0.5cm}
        \includegraphics[width=0.3\textheight]{[RESULT_GRAPH0]}
        \vfill
        \caption{True Graph}
        \label{fig:sub1}
    \end{subfigure}
    \hspace{0.04\textwidth}0.3\textheight0.3\textheight0.3\textheight
    \begin{subfigure}{0.45\textwidth}
        \centering
        \vspace{-0.5cm}
