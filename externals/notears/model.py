...
def dual_ascent_step(model: MODEL_NTS_NOTEARS, normalized_X, device, lambda1, lambda2, rho, alpha, h, rho_max):
...
def train_NTS_NOTEARS(model: MODEL_NTS_NOTEARS,
                      normalized_X,
                      device,
...
def main():
    ...
    model = MODEL_NTS_NOTEARS(dims=[d, 10, 1], bias=True, number_of_lags=number_of_lags,
