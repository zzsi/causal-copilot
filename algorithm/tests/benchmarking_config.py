...
class BenchmarkConfig:
    # Data directory
    data_dir: str = "simulated_data/algorithm_benchmarking"
    # Output directory
    output_dir: str = "simulated_data/algorithm_benchmarking_results"
    ...
    edge_probabilities: List[float] = field(default_factory=lambda: [0.1, 0.2, 0.3])
    ...
    missing_ratios: List[float] = field(default_factory=lambda: [0.05, 0.1, 0.15])

    # Algorithm settings
    algorithms: List[str] = field(default_factory=lambda: ['PC', 'FCI', 'CDNOD', 'GES', 'FGES', 
                                                           'XGES', 'DirectLiNGAM', 'AcceleratedDirectLiNGAM', 
                                                           'ICALiNGAM', 'NOTEARS'])
